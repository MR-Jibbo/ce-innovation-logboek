...
- **`CE-Innovation Logboek 2.2.0 (Apple Silicon).dmg`** → voor nieuwere Macs (vanaf eind 2020, met een M1/M2/M3/M4-chip — de meeste studenten).
- `CE-Innovation Logboek 2.2.0 (Intel).dmg` → voor oudere Intel-Macs.
- `CE-Innovation Logboek Setup 2.2.0.exe` → voor Windows-gebruikers.
